...
class AlphaDeskMultiWindowManager {
  AlphaDeskMultiWindowManager._();

  static final instance = AlphaDeskMultiWindowManager._();
...
final rustDeskWinManager = AlphaDeskMultiWindowManager.instance;
