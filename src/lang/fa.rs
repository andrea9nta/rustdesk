...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("install_tip", "لطفا برنامه را نصب کنید UAC و جلوگیری از خطای AlphaDesk برای راحتی در استفاده از نرم افزار"),
        ("Click to upgrade", "برای ارتقا کلیک کنید"),
        ("Click to download", "برای دانلود کلیک کنید"),
        ("Click to update", "برای به روز رسانی کلیک کنید"),
        ("Configure", "تنظیم"),
        ("config_acc", "بدهید \"access\" مجوز AlphaDesk برای کنترل از راه دور دسکتاپ باید به"),
        ("config_screen", "بدهید \"screenshot\" مجوز AlphaDesk برای کنترل از راه دور دسکتاپ باید به"),
        ...
        ("android_input_permission_tip1", "استفاده کند \"Accessibility\" اجازه دهید از ویژگی AlphaDesk شما را از طریق ماوس یا صفحه ی لمسی کنترل کند، باید به Android برای اینکه یک دستگاه از راه دور بتواند دستگاه"),
        ("android_input_permission_tip2", "را پیدا کنید و فعال نمایید \"AlphaDesk Input\" بشوید ، سپس گزینه \"Installed Services\" وارد قسمت \"Accessibility\" در صفحه تنظیمات "),
        ...
        ("Language", "زبان"),
        ("Keep AlphaDesk background service", "را در پس زمینه نگه دارید AlphaDesk سرویس"),
        ...
        ("Show AlphaDesk", "AlphaDesk نمایش"),
        ("This PC", "This PC"),
        ("or", "یا"),
        ...
        ("config_input", "برای کنترل دسکتاپ از راه دور با صفحه کلید، باید مجوز AlphaDesk \"Input Monitoring\" را بدهید."),
        ("config_microphone", "را بدهید. AlphaDesk \"Record Audio\" برای صحبت از راه دور، باید مجوز"),
        ...
        ("still_click_uac_tip", "همچنان کاربر از راه دور نیاز دارد که روی OK در پنجره UAC اجرای AlphaDesk کلیک کند."),
        ...
        ("install_cert_tip", "AlphaDesk نصب گواهی"),
        ("confirm_install_cert_tip", "استفاده خواهد شد AlphaDesk است و شما می توانید به این گواهی اعتماد کنید. این گواهی برای اعتماد و نصب درایورهای AlphaDesk این گواهینامه یک گواهی تست"),
        ...
        ("verify_rustdesk_password_tip", "رمز عبور AlphaDesk را تأیید کنید"),
