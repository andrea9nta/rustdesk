...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Menghubungkan ke jaringan AlphaDesk..."),
        ...
        ("install_tip", "Karena UAC, AlphaDesk tidak dapat bekerja dengan baik sebagai sisi remote dalam beberapa kasus. Untuk menghindari UAC, silakan klik tombol di bawah ini untuk menginstal AlphaDesk ke sistem."),
        ("Click to upgrade", "Klik untuk upgrade"),
        ("Click to download", "Klik untuk unduh"),
        ("Click to update", "Klik untuk memperbarui"),
        ("Configure", "Konfigurasi"),
        ("config_acc", "Untuk mengontrol Desktop Anda dari jarak jauh, Anda perlu memberikan izin \"Aksesibilitas\" AlphaDesk."),
        ("config_screen", "Untuk mengakses Desktop Anda dari jarak jauh, Anda perlu memberikan izin \"Perekaman Layar\" AlphaDesk."),
        ...
        ("android_input_permission_tip1", "Agar perangkat jarak jauh dapat mengontrol perangkat Android Anda melalui mouse atau sentuhan, Anda harus mengizinkan AlphaDesk untuk menggunakan layanan \"Aksesibilitas\"."),
        ("android_input_permission_tip2", "Silakan buka halaman pengaturan sistem berikutnya, temukan dan masuk ke [Layanan Terinstal], aktifkan layanan [Input AlphaDesk]."),
        ...
        ("Language", "Bahasa"),
        ("Keep AlphaDesk background service", "Pertahankan AlphaDesk berjalan pada service background"),
        ...
        ("Show AlphaDesk", "Tampilkan AlphaDesk"),
        ("This PC", "PC ini"),
        ("or", "atau"),
        ...
        ("config_input", "Untuk menggunakan input keyboard remote, anda perlu memberikan izin \"Pemantauan Input\" pada AlphaDesk"),
        ("config_microphone", "Untuk berbicara secara remote, anda perlu memberikan izin \"Rekam Audio\" pada AlphaDesk"),
        ...
        ("still_click_uac_tip", "Masih memerlukan persetujuan pihak pengguna remote untuk mengklik OK pada jendela UAC AlphaDesk yang sedang berjalan"),
        ...
        ("install_cert_tip", "Install sertifikat AlphaDesk"),
        ("confirm_install_cert_tip", "Ini adalah sertifikat pengujian AlphaDesk, yang dapat dipercaya. Sertifikat ini akan digunakan untuk menginstal driver AlphaDesk saat diperlukan"),
        ...
        ("verify_rustdesk_password_tip", "Verifikasi Kata Sandi AlphaDesk"),
        ...
        ("scam_text1", "Jika Anda sedang berbicara di telepon dengan seseorang yang TIDAK dikenal dan mereka meminta anda untuk menggunakan AlphaDesk, jangan lanjutkan dan segera tutup panggilan."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Silahkan perbarui AlphaDesk Server Pro ke versi {} atau yang lebih baru!"),
