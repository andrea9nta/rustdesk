...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Ansluter till AlphaDesk..."),
        ...
        ("install_tip", "På grund av UAC, kan inte AlphaDesk fungera ordentligt på klientsidan. För att undvika problem med UAC, tryck på knappen nedan för att installera AlphaDesk på systemet."),
        ...
        ("config_acc", "För att kontrollera din dator på distans måste du ge AlphaDesk \"Tillgänglighets\" rättigheter."),
        ("config_screen", "För att kontrollera din dator på distans måste du ge AlphaDesk \"Skärminspelnings\" rättigheter."),
        ...
        ("android_input_permission_tip2", "Gå till systeminställningarna, hitta [Installed Services], sätt på [AlphaDesk Input] tjänsten."),
        ...
        ("Language", "Språk"),
        ("Keep AlphaDesk background service", "Behåll AlphaDesk i bakgrunden"),
        ("Ignore Battery Optimizations", "Ignorera batterioptimering"),
        ("android_open_battery_optimizations_tip", "Om du vill stänga av denna funktion, gå till nästa AlphaDesk programs inställningar, hitta [Batteri], Checka ur [Obegränsad]"),
        ("Start on boot", ""),
