...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Ready", "Prêt"),
        ("Established", "Établi"),
        ("connecting_status", "Connexion au réseau AlphaDesk..."),
        ...
        ("config_acc", "Afin de pouvoir contrôler votre bureau à distance, veuillez donner l'autorisation \"accessibilité\" à AlphaDesk."),
        ("config_screen", "Afin de pouvoir accéder à votre bureau à distance, veuillez donner à AlphaDesk l'autorisation \"enregistrement d'écran\"."),
        ...
        ("android_input_permission_tip1", "Pour qu'un appareil distant puisse contrôler votre appareil Android via la souris ou le toucher, vous devez autoriser AlphaDesk à utiliser le service \"Accessibilité\"."),
        ("android_input_permission_tip2", "Veuillez accéder à la page suivante des paramètres système, recherchez et entrez [Services installés], activez le service [AlphaDesk Input]."),
        ...
        ("Language", "Langue"),
        ("Keep AlphaDesk background service", "Gardez le service AlphaDesk en arrière plan"),
        ...
        ("Show AlphaDesk", "Afficher AlphaDesk"),
        ("This PC", "Ce PC"),
        ("or", "ou"),
        ...
        ("config_input", "Afin de contrôler le bureau à distance avec le clavier, vous devez accorder à AlphaDesk l'autorisation \"Surveillance de l’entrée\"."),
        ("config_microphone", "Pour discuter à distance, vous devez accorder à AlphaDesk les autorisations « Enregistrer l'audio »."),
        ...
        ("still_click_uac_tip", "Nécessite toujours que l'utilisateur distant confirme par la fenêtre UAC de AlphaDesk en cours d'éxécution."),
        ...
        ("install_cert_tip", "Installer le certificat AlphaDesk"),
        ("confirm_install_cert_tip", "Il s'agit d'un certificat AlphaDesk, auquel on peut faire confiance. Le certificat sera utilisé pour approuver et installer les pilotes AlphaDesk si nécessaire."),
        ...
        ("verify_rustdesk_password_tip", "Vérifier le mot de passe AlphaDesk"),
        ...
        ("scam_text1", "Si vous êtes au téléphone avec quelqu'un QUE VOUS NE CONNAISSEZ PAS et en qui VOUS N'AVEZ PAS CONFIANCE et qui vous a demandé d'utiliser AlphaDesk et de démarrer le service, ne le faites pas et raccrochez immédiatement."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Veuillez mettre à jour AlphaDesk Server Pro avec la version {} ou une version plus récente !"),
