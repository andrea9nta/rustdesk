...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Verbinden mit dem AlphaDesk-Netzwerk …"),
        ...
        ("install_tip", "Aufgrund der Benutzerkontensteuerung (UAC) kann AlphaDesk in manchen Fällen nicht ordnungsgemäß funktionieren. Um die Benutzerkontensteuerung zu umgehen, klicken Sie bitte auf die Schaltfläche unten und installieren AlphaDesk auf dem System."),
        ...
        ("config_acc", "Um Ihren PC aus der Ferne zu steuern, müssen Sie AlphaDesk Zugriffsrechte erteilen."),
        ("config_screen", "Um aus der Ferne auf Ihren PC zugreifen zu können, müssen Sie AlphaDesk die Berechtigung \"Bildschirmaufnahme\" erteilen."),
        ...
        ("android_input_permission_tip1", "Damit ein entferntes Gerät Ihr Android-Gerät steuern kann, müssen Sie AlphaDesk erlauben, den Dienst \"Barrierefreiheit\" zu verwenden."),
        ("android_input_permission_tip2", "Bitte gehen Sie zur nächsten Systemeinstellungsseite, suchen Sie \"Installierte Dienste\" und schalten Sie den Dienst \"AlphaDesk Input\" ein."),
        ...
        ("Language", "Sprache"),
        ("Keep AlphaDesk background service", "AlphaDesk im Hintergrund ausführen"),
        ...
        ("Show AlphaDesk", "AlphaDesk anzeigen"),
        ("This PC", "Dieser PC"),
        ("or", "oder"),
        ...
        ("config_input", "Um den entfernten Desktop mit der Tastatur steuern zu können, müssen Sie AlphaDesk die Berechtigung \"Eingabeüberwachung\" erteilen."),
        ("config_microphone", "Um aus der Ferne sprechen zu können, müssen Sie AlphaDesk die Berechtigung \"Audio aufzeichnen\" erteilen."),
        ...
        ("still_click_uac_tip", "Der entfernte Benutzer muss immer noch im UAC-Fenster von AlphaDesk auf \"Ja\" klicken."),
        ...
        ("install_cert_tip", "AlphaDesk-Zertifikat installieren"),
        ("confirm_install_cert_tip", "Dies ist ein AlphaDesk-Testzertifikat, dem vertraut werden kann. Das Zertifikat wird verwendet, um AlphaDesk-Treibern bei Bedarf zu vertrauen und diese zu installieren."),
        ...
        ("verify_rustdesk_password_tip", "AlphaDesk-Passwort bestätigen"),
        ...
        ("scam_text1", "Wenn Sie mit jemandem telefonieren, den Sie NICHT KENNEN, dem Sie NICHT VERTRAUEN und der Sie gebeten hat, AlphaDesk zu benutzen und den Dienst zu starten, fahren Sie nicht fort und legen Sie sofort auf."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Bitte aktualisieren Sie AlphaDesk Server Pro auf die Version {} oder neuer!"),
        ...
        ("selinux_tip", "SELinux ist auf Ihrem Gerät aktiviert, was dazu führen kann, dass AlphaDesk als kontrollierte Seite nicht richtig läuft."),
