...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Ready", "준비"),
        ("Established", "연결됨"),
        ("connecting_status", "AlphaDesk 네트워크로 연결중입니다..."),
        ...
        ("OS Password", "OS 비밀번호"),
        ("install_tip", "UAC로 인해, AlphaDesk가 원격지일 때 일부 기능이 동작하지 않을 수 있습니다. UAC 문제를 방지하려면, 아래 버튼을 클릭하여 AlphaDesk를 시스템에 설치해주세요."),
        ("Click to upgrade", "클릭하여 업그레이드"),
        ("Click to download", "클릭하여 다운로드"),
        ("Click to update", "클릭하여 업데이트"),
        ("Configure", "구성"),
        ("config_acc", "당신의 데스크탑을 원격으로 제어하기 전에, AlphaDesk에게 \"Accessibility (접근성)\" 권한을 부여해야 합니다."),
        ("config_screen", "당신의 데스크탑을 원격으로 제어하기 전에, AlphaDesk에게 \"Screen Recording (화면 녹화)\" 권한을 부여해야 합니다."),
        ("Installing ...", "설치중 ..."),
        ("Install", "설치하기"),
        ("Installation", "설치"),
        ...
        ("android_input_permission_tip1", "원격지로서 마우스나 터치를 통해 Android 장치를 제어하려면 AlphaDesk에서 \"Accessibility (접근성)\" 서비스 사용을 허용해야 합니다."),
        ("android_input_permission_tip2", "시스템 설정 페이지로 이동하여 [설치된 서비스]에서 [AlphaDesk Input] 서비스를 켜십시오."),
        ...
        ("Language", "언어"),
        ("Keep AlphaDesk background service", "AlphaDesk 백그라운드 서비스로 유지하기"),
        ("Ignore Battery Optimizations", "배터리 최적화 무시하기"),
        ("android_open_battery_optimizations_tip", "해당 기능을 비활성화하려면 AlphaDesk 응용 프로그램 설정 페이지로 이동하여 [배터리]에서 [제한 없음] 선택을 해제하십시오."),
        ...
        ("config_input", "키보드를 통해 원격 데스크톱을 제어할 수 있으려면 AlphaDesk의 \"입력 모니터링\" 권한을 부여해 주세요"),
        ("config_microphone", "마이크를 통한 오디오 전송을 지원하려면 AlphaDesk에 \"녹음\" 권한을 부여하세요"),
        ...
        ("still_click_uac_tip", "통제된 사용자는 여전히 AlphaDesk를 실행하는 UAC 창에서 확인을 클릭해야 합니다"),
        ...
        ("install_cert_tip", "AlphaDesk 인증서 설치"),
        ("confirm_install_cert_tip", "이 인증서는 AlphaDesk 테스트 인증서이므로 신뢰할 수 있습니다. 인증서는 AlphaDesk 드라이버를 신뢰하고 설치하는 데 사용됩니다"),
        ("RDP Settings", "RDP 설정"),
        ("Sort by", "정렬 기준"),
        ...
        ("verify_rustdesk_password_tip", "AlphaDesk 비밀번호 확인"),
        ...
        ("scam_text1", "모르는 사람과 통화 중이고 그들이 AlphaDesk를 사용하여 서비스를 시작하라고 요청하는 경우, 계속하지 말고 즉시 전화를 끊으세요"),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "AlphaDesk 서버 전문가 버전 {} 으로 업그레이드하세요"),
        ...
        ("selinux_tip", "SELinux를 활성화하면 AlphaDesk가 호스트로 제대로 실행되지 않을 수 있습니다"),
        ("Change view", "보기 변경"),
        ("Big tiles", "큰 타일"),
        ("Small tiles", "작은 타일"),
        ("List", "리스트"),
