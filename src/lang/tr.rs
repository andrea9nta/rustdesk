...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("install_tip", "Kullanıcı Hesabı Denetimi nedeniyle, AlphaDesk bir uzak masaüstü olarak düzgün çalışmayabilir. Bu sorunu önlemek için, AlphaDesk'i sistem seviyesinde kurmak için aşağıdaki butona tıklayın."),
        ...
        ("Configure", "Ayarla"),
        ("config_acc", "Masaüstünüzü dışarıdan kontrol etmek için AlphaDesk'e \"Erişilebilirlik\""),
        ("config_screen", "Masaüstünüzü dışarıdan kontrol etmek için AlphaDesk'e \"Ekran Kaydı\" iznini vermeniz gerekir."),
        ...
        ("android_input_permission_tip1", "Uzak bir cihazın Android cihazınızı fare veya dokunma yoluyla kontrol edebilmesi için, AlphaDesk'in \"Erişilebilirlik\" özelliğini kullanmasına izin vermelisiniz."),
        ("android_input_permission_tip2", "Sonraki sistem ayarları sayfasına gidin, [Yüklü Hizmetler]'i bulun ve erişin, [AlphaDesk Girişi] hizmetini etkinleştirin."),
        ...
        ("Language", "Dil"),
        ("Keep AlphaDesk background service", "AlphaDesk arka plan hizmetini sürdürün"),
        ...
        ("Show AlphaDesk", "AlphaDesk'i Göster"),
        ("This PC", "Bu PC"),
        ("or", "veya"),
        ...
        ("config_input", "Uzaktaki masaüstünü klavye ile kontrol etmek için AlphaDesk'e \"Giriş İzleme\" izinleri vermelisiniz."),
        ("config_microphone", "Uzaktan konuşmak için AlphaDesk'e \"Ses Kaydı\" izinleri vermelisiniz."),
        ...
        ("still_click_uac_tip", "Uzaktaki kullanıcının çalışan AlphaDesk'in UAC penceresinde hala Tamam'ı tıklaması gerekmektedir."),
        ...
        ("install_cert_tip", "AlphaDesk sertifikasını yükleyin"),
        ("confirm_install_cert_tip", "Bu, güvenilir olabilecek bir AlphaDesk test sertifikasıdır. Sertifika, gerekli olduğunda AlphaDesk sürücülerini güvenilir ve yüklemek üzere kullanacaktır."),
        ...
        ("verify_rustdesk_password_tip", "AlphaDesk parolasını doğrulayın"),
