...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Opretter forbindelse til AlphaDesk-netværket..."),
        ...
        ("install_tip", "På grund af UAC kan AlphaDesk ikke fungere korrekt i nogle tilfælde på fjernskrivebordet. For at undgå UAC skal du klikke på knappen nedenfor for at installere AlphaDesk på systemet"),
        ...
        ("android_input_permission_tip1", "For at en ekstern enhed kan kontrollere din Android-enhed via mus eller berøring, skal du give AlphaDesk mulighed for at bruge tjenesten \"tilgængelighed \"."),
        ("android_input_permission_tip2", "Gå til den næste systemindstillingsside, søg og indtast [installerede tjenester], tænd for [AlphaDesk Input] tjenesten."),
        ...
        ("Language", "Sprog"),
        ("Keep AlphaDesk background service", "Behold AlphaDesk baggrundstjeneste"),
